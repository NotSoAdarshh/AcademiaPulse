...
function LoginPage() {
  return (
    <div >
      <div className="bg-bg h-dvh w-screen text-heading justify-center items-center flex ">
        <div className="bg-surface font-rajdhani font-bold lg:h-1/4 lg:w-3/7 w-7/8 h-1/4 rounded-2xl text-center text-[30px] items-center justify-center flex flex-col ">
